...
work:
  ...
  - position: Publications & Research
    company_name: 'Research Publications'
    company_url: ''
    company_logo: ''
    date_start: 2024-01-01
    date_end: 2025-01-01
    summary: |
      **MCVL: 계절 및 광원 변화에 강인한 다방향 카메라 기반 영상 측위** (2025)
      - 제어로봇시스템학회 논문지, 31(2), 153-159
      - 다방향에서 촬영된 이미지의 retrieval을 이용한 visual localization 연구
      
      **칼만 필터 기반의 영상 재선택** (2024)
      - 제어로봇시스템학회 논문지, 30(9), 954-959
      - 영상 검색 기반 영상 측위에서 Collinear와 높은 Co-visibility 상황 처리
      
      **5G-NR-V2X 기반 상호간 경로 공유를 통한 협력 차선 변경 시스템** (2024)
      - 제어로봇시스템학회 논문지, 30(4), 492-499

  - position: Conference Presentations
    company_name: 'Academic Conferences'
    company_url: ''
    company_logo: ''
    date_start: 2023-11-01
    date_end: 2024-10-01
    summary: |
      **ICCAS 2024** - Analysis of Error Trends by Range in Visual Localization
      - 2024 24th International Conference on Control, Automation and Systems
      
      **대한전자공학회 학술대회** - 영상 검색 기반 측위 기술에 따른 위치 추정 성능 분석
  ...
  - position: Major Projects
    company_name: 'Research & Development Projects'
    company_url: ''
    company_logo: ''
    date_start: 2020-03-01
    date_end: 2024-10-01
    summary: |
      **자율주행 임시운행 허가 취득** (2024-현재)
      - State machine 기반의 MPC(Model Predictive Controller) 구현
      - QGIS를 이용한 지도 제작
      - 국토교통부 지정 요건에 맞춘 도심로 자율주행 임시운행허가 취득
      
      **5G-NR-V2X 기반 Advanced Driving 서비스 개발** (2023-현재)
      - 5G-NR-V2X 관련 표준 조사 및 자율주행차 H/W Configuration
      - (주) 오비고와 협력
      
      **2024 대학생 자율주행 경진대회** (2024.01-2024.10)
      - Visual localization 및 RTK/GNSS 담당
      - 대구 KIAPI 고속주회로에서 준우승 달성
      
      **RTOD-SLAM: Real-Time Object Detection VSLAM** (2022.03-2022.06)
      - Stereo 카메라를 사용한 VSLAM으로 만든 map에서 객체 인식을 통해 Semantic mapping 구현
      
      **시각장애인 안내 4족 보행 로봇 시스템** (2020.09-2021.08)
      - SLAM과 인공지능 기반의 시각장애인 안내 시스템
      - 팀장 및 앱 개발 담당
      
      **신호등이 없는 횡단보도 사고 방지 로봇 시스템** (2020.03-2020.09)
      - 인공지능 기반의 이동형 로봇 시스템
      - 팀장 및 앱 개발 담당
